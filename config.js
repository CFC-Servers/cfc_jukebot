module.exports = {
	...
	adminId: "173634281116008448", //- Replace UserId with the Discord ID of the admin of the bot
	...
	supportServer: "https://discord.gg/cfc-servers", //- Support Server Link
	...
	cookieSecret: "attendant-dial-cheese", //- Cookie Secret
  website: "https://jukebot.cfcservers.org", //- without the / at the end
	...
	nodes: [
		{
			...
			password: "ramble-gallery-scoreless", //- The password of the lavalink server.
